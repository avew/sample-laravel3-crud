...
class Generate_Task {
    ...
    // JavaScripts
    'jquery.js' => 'http://code.jquery.com/jquery.js', 'backbone.js' => 'http://backbonejs.org/backbone.js', 'underscore.js' => 'http://underscorejs.org/underscore.js', 'handlebars.js' => 'http://cloud.github.com/downloads/wycats/handlebars.js/handlebars-1.0.rc.1.js',
...
EOT;
    ...
    protected function parse_table_name($class_name) {
        ...
        return empty($matches) ? "TABLE" : $matches[1];
    }
    ...
    protected function set_column($type, $field = '') {
        return empty($field) ? "\$table->$type()" : "\$table->$type('$field')";
    }
...
EOT;
    ...
    public static function schema($table_action, $table_name, $cb = true) {
        ...
        return $cb ? $content . ', function($table) {});' : $content . ');';
    }
